        ...
        content: {
          "application/json": {
            ...
            data?: (
              ...
              | components["schemas"]["bounds"]
              | components["schemas"]["monitor"]
            )[];
          };
        };
      };
        ...
        content: {
          "application/json": {
            ...
            data?: (
              ...
              | components["schemas"]["traceAction"]
              | components["schemas"]["traceResult"]
        ...
        content: {
          "application/json": {
            ...
            data?: (
              | components["schemas"]["message"]
              | components["schemas"]["monitor"]
              | components["schemas"]["monitorClean"]
            )[];
          };
        };
      };
        ...
        content: {
          "application/json": {
            ...
            data?: (
              ...
              | components["schemas"]["blockCount"]
              | components["schemas"]["lightBlock"]
              | components["schemas"]["log"]
              | components["schemas"]["message"]
              | components["schemas"]["trace"]
              | components["schemas"]["traceAction"]
        ...
        content: {
          "application/json": {
            ...
            data?: (
              ...
              | components["schemas"]["trace"]
              | components["schemas"]["traceAction"]
              | components["schemas"]["traceCount"]
              | components["schemas"]["traceFilter"]
              | components["schemas"]["traceResult"]
            )[];
          };
        };
      ...
      200: {
        ...
        content: {
          "application/json": {
            ...
            data?: (
              | components["schemas"]["appearance"]
              | components["schemas"]["appearanceTable"]
              | components["schemas"]["chunkAddress"]
              | components["schemas"]["chunkBloom"]
              | components["schemas"]["chunkIndex"]
              | components["schemas"]["chunkPin"]
              | components["schemas"]["chunkRecord"]
              | components["schemas"]["chunkStats"]
              | components["schemas"]["count"]
              | components["schemas"]["ipfsPin"]
              | components["schemas"]["manifest"]
              | components["schemas"]["message"]
              | components["schemas"]["rangeDates"]
              | components["schemas"]["reportCheck"]
            )[];
          };
        };
      };
